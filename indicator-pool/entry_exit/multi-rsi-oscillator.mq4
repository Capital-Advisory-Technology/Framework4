...
input bool                 PeriodM1 = true;              // 1 Minute
input bool                 PeriodM5 = true;              // 5 Minutes
input bool                 PeriodM15 = true;             // 15 Minutes
input bool                 PeriodM30 = true;             // 30 Minutes
input bool                 PeriodH1 = true;              // 1 Hour
input bool                 PeriodH4 = true;              // 4 Hours
input bool                 PeriodD1 = true;              // 1 Day
...
int OnInit()
  {
   ...
   IndicatorShortName("MultiRSI["+timeFrames+"]("+IntegerToString(PeriodRSI)+")");
