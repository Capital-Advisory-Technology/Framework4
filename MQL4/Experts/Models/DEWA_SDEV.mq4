...
extern string strategy_name = "DEWA-STDDEV-1.0";
extern bool fixed_sltp = false;
extern int slippage = 3;
extern double exportPFThreshold = 1.25;
...
void OnTick() {
    ...
    Logger::log("OnTick: Action: " + string(action) + " Confirm: " + string(confirm) + " STDDEV Confirm: " + string(stdConfirm));
